/**
 * Google Maps API Integration for External WebDev Templates
 * 
...
function getMapsConfig(): MapsConfig {
  ...
  if (!baseUrl || !apiKey) {
    throw new Error(
      "Google Maps proxy credentials missing: set EXTERNAL_SERVICE_API_URL and EXTERNAL_SERVICE_API_KEY"
    );
  }
